    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-info">
                ...
                <!-- /.card-header -->
                <form class="form-horizontal" method="POST" action="{{ route('Usuario.update', $usuario[0]->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 input-group">
                                <input id="sucursal" list="sucursalData" type="text" class="form-control @error('sucursal') is-invalid @enderror" name="sucursal" value="{{ $usuario[0]->sucursal}}" required autocomplete="sucursal" placeholder="Selecciona una Sucursal">
