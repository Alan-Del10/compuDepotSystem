        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-danger">
                        <div class="inner">
                            ...
                            <p>Productividad Canales de Venta</p>
                        </div>
                        <div class="icon">
            ...
            <div class="row">
                ...
                <section class="col-lg-7 connectedSortable">
                    @if (Auth::guard('admin')->check() || Auth::guard('root')->check() || Auth::guard('sub_admin')->check())
                        <!-- TO DO List -->
                        <div class="card">
                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg">
                                    ...
                                    <div class="direct-chat-text">
                                        Buenas tardes, cómo va mi pedido?
                                    </div>
                                    <!-- /.direct-chat-text -->
                                </div>
                                <!-- /.direct-chat-msg -->
                                ...
                                <div class="direct-chat-msg right">
                                    ...
                                    <!-- /.direct-chat-infos -->
                                    <img class="direct-chat-img" src="dist/img/user5-128x128.jpg" alt="message user image">
                                    <!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">
                                        Claro, pérmitame un momento
                                    </div>
                                    <!-- /.direct-chat-text -->
                                </div>
                                <!-- /.direct-chat-msg -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="todo-list" data-widget="todo-list">
                                <li>
                                    ...
                                    <!-- todo text -->
                                    <span class="text">Diseñar nuevas vistas</span>
                                    <!-- Emphasis label -->
                                ...
                                <li>
                                    ...
                                    <span class="text">Probar tema responsivo</span>
                                ...
                                <li>
                                    ...
                                    <span class="text">Mostrar avances</span>
                                ...
                                <li>
                                    ...
                                    </div>Esperar nuevo empleado</span>
                                ...
                                <li>
                                    ...
                                    <span class="text">Entregar versión pre-alpha de la APP</span>
                                    <small class="badge badge-secondary"><i class="far fa-clock"></i> 2 mes</small>
                                    <div class="tools">
                                        <i class="fas fa-edit"></i>
                                        <i class="fas fa-trash-o"></i>
                                    </div>
                        ...
                        <div class="card-footer clearfix">
                            <button type="button" class="btn btn-info float-right"><i class="fas fa-plus"></i>Agregar
                                nota</button>
                        </div>
                    </div>
                    <!-- /.card -->
                        ...
                        <div class="card-footer bg-transparent">
                            <div class="row">
                                <div class="col-4 text-center">
                                    ...
                                    <div class="text-white">Ordenes por Correo</div>
                                </div>
                                <!-- ./col -->
                                <div class="col-4 text-center">
                                    ...
                                    <div class="text-white">Mercado Libre</div>
                                </div>
                                <!-- ./col -->
                                <div class="col-4 text-center">
