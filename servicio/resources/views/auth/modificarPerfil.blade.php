    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-info">
                ...
                <!-- /.card-header -->
                <form class="form-horizontal" method="POST" action="{{ route('updatePerfil', $perfil->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $perfil->email }}" required autocomplete="email">
