...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <ul class="nav nav-pills ml-auto">
                                    <li class="nav-item">
                                        <a id="agregarVenta" href='{{ route('Compra.create') }}'
                                            class="btn btn-primary btn-sm">Agregar Compra <i class="far fa-plus-square"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <!-- /.card -->
                    {{ $compras->onEachSide(5)->links('pagination::bootstrap-4') }}
                </div>
                <!-- /.col -->
            </div>
            <!-- /.row -->
    ...
    <script>
        ...
        $("#busqueda").on("keyup", function() {
            ...
            console.log(getResult(value, compras));
        });
